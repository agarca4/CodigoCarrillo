...
public abstract class Baraja<T> {
	...
	public void barajar() {
		...
		for (int i = 0; i < cartas.length; i++) {
			...
			posAleatoria = MetodosSueltos.generaNumeroAleatorio(0, numCartas - 1);
	...
	/**
	 * Devuelve la carta donde se encuentre "posSiguienteCarta"
	 *
	...
	public Carta<T>[] getCartas() {
		return cartas;
	}

	public void setCartas(Carta<T>[] cartas) {
		this.cartas = cartas;
	}
